  ...
  return <Main>
    <Container>
      <MetaTags>
        ...
        <meta name="description" content="Хакатон - Создание проекта" />
        <meta property="og:title" content="Создание проекта" />
      </MetaTags>
      <Title title='Создание проекта' />
      <Form
        ...
        onSubmit={e => {
          ...
          .catch(err => {
            const { non_field_errors, ingredients, time } = err
            if (non_field_errors) {
            ...
            // }
            if (time) {
              return alert(`Сроки выполнения: ${time[0]}`)
            }
      ...
      >
        ...
        <div className={styles.cookingTime}>
          <Input
            ...
            value={recipeTime}
          />
          <div className={styles.cookingTimeUnit}>дни</div>
        </div>
        <Textarea
